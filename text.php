...
//define("SENDGRID_API_KEY", "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");
...

{
    ...
    $mail_to =   $_SESSION["mailer"];
    $mail_subject = "Welcome to Money Sender";
    $mail_body = "Hey ". $namer . ", It's nice to have you here!";
